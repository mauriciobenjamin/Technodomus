...
var defaultNotification = function defaultNotification(err) {
  return {
    subtitle: err.plugin,
    message: err.message,
    sound: 'Funk',
...
gulp.task('build', ['copy', 'imagemin', 'jade', 'sass', 'browserify']);

// Server tasks with watch
gulp.task('serve', ['imagemin', 'copy', 'jade', 'sass', 'browserify', 'browserSync', 'watch']);
